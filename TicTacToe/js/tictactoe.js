...
function checkWinConditions() {
    ...
    else if  (arrayIncludes('3X', '5X', '8X')) { drawWinLine(508, 50, 508, 558); }
    ...
    //and nine squares are selected, the code executes.
    ...
    //This function checks if an array includes three strings.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the three variables we pass are all included in our array true is returned
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //It was necessay for the 6, 4, 2 win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y-= 10; }
            if (x >= x2 && y <= y2) {  cancelAnimationFrame(animationLoop);  }
    ...
    //This line calls our main ani9mation loop.
    animateLineDrawing();
